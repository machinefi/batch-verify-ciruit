...
mod tests {
    ...
    macro_rules! test_circuit {
        (
            ...
            use crate::circuits::halo2wrong::curves::bn256::{Fq as BnBase, Fr as BnScalar};
            use crate::circuits::halo2wrong::curves::pasta::{Fp as PastaFp, Fq as PastaFq};
            use crate::circuits::halo2wrong::curves::secp256k1::{Fp as Secp256k1Base, Fq as Secp256k1Scalar};
            test_circuit_runner!(
                $circuit,
                [PastaFp, PastaFq, 68],
                [PastaFq, PastaFp, 68],
