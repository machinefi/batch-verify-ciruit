    ...
    > GeneralEccChip<Emulated, N, NUMBER_OF_LIMBS, BIT_LEN_LIMB>
{
    ...
    pub fn expose_public(
        ...
        use crate::circuits::maingate::MainGateInstructions;
...
mod tests {
    ...
    fn test_general_ecc_addition_circuit() {
        ...
        use crate::circuits::halo2wrong::curves::bn256::{Fr as BnScalar, G1Affine as Bn256};
        use crate::circuits::halo2wrong::curves::pasta::{
            EpAffine as Pallas, EqAffine as Vesta, Fp as PastaFp, Fq as PastaFq,
        };
        use crate::circuits::halo2wrong::curves::secp256k1::Secp256k1Affine as Secp256k1;
