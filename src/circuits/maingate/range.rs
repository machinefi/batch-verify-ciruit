...
impl<F: PrimeField> RangeChip<F> {
    ...
    pub fn configure(
        ...
        macro_rules! meta_lookup {
            ($name:expr, $column:expr, $selector:expr,$table:expr) => {
        ...
        meta_lookup!("a", a, s_dense_limb_range, dense_limb_range_table);
        meta_lookup!("b", b, s_dense_limb_range, dense_limb_range_table);
        meta_lookup!("c", c, s_dense_limb_range, dense_limb_range_table);
        meta_lookup!("d", d, s_dense_limb_range, dense_limb_range_table);
        ...
        let fine_tune_tables = fine_tune_bit_lengths
            ...
            .map(|bit_len| {
                ...
                meta_lookup!("b", b, selector, column);
...
mod tests {
    ...
    use crate::circuits::maingate::instructions::MainGateInstructions;
